...
- **`prefer_folders` override** - force files from a specific set of folders to always be kept, transferring favorite metadata from files in non-preferred folders if necessary
